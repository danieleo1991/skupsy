				...
				content: [
					{
						...
						text: `
...

							{
								...
								Jeśli stan przedmiotu (czyli parametr 'condition') ma wartość '10' to wtedy kwotę, która znajduje się w 'used_item_price' pomniejsz o 60%, natomiast jeśli parametr 'condition' ma wartość '9' to pomniejsz o 65%, a jeśli parametr 'condition' ma wartość '8' to pomniejsz o 70%, a jeśli parametr 'condition' ma wartość '7' to pomniejsz o 75%, a jeśli parametr 'condition' ma wartość '6' to pomniejsz o 80%, a jeśli parametr 'condition' ma wartość '5' to pomniejsz o 85%, a jeśli parametr 'condition' ma wartość '4' to pomniejsz o 90%, a jeśli parametr 'condition' ma wartość '3' lub poniżej to pomniejsz o 90%.
