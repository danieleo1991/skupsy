				...
				content: [
					{
						...
						text: `
...

							{
								...
								Jeśli stan przedmiotu (czyli parametr 'condition') ma wartość '10' to wtedy kwotę, która znajduje się w 'used_item_price' pomniejsz o 50%, natomiast jeśli parametr 'condition' ma wartość '1' to pomniejsz o 70% i tak analogicznie do reszty wartości (1-10).
